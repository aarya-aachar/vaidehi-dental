...
<title>Book Appointment - Vaidehi Dental</title>
<link rel="stylesheet"
	...
	<div class="portal-container">
		...
		<div class="sidebar">
			...
			<ul class="sidebar-nav">
				...
				<li class="active"><a
					href="/dentalClinic/patient/appointments/new"> <i
		...
		<div class="main-content">
			...
			<div class="booking-container">
				<form id="appointmentForm" action="${pageContext.request.contextPath}/patient/appointments/new"
					method="post">
					<div class="form-section">
							...
							<div class="form-row">
								<div class="form-group">
									<label class="form-label">Doctor</label> <select
										class="form-control" id="doctor_id" name="doctor_id" required>
										...
										%>
										<option value="<%=doctor.getDoctorId()%>">Dr.
											<%=doctor.getFirstName()%>
											<%=doctor.getLastName()%>
										</option>
										<%
						...
						<div class="form-row">
							<div class="form-group">
								...
								<textarea class="form-control" name="patient_description"
