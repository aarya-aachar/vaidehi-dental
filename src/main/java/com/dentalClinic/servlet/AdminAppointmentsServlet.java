...
public class AdminAppointmentsServlet extends HttpServlet {
     ...
     */
    public AdminAppointmentsServlet() {
        super();
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (isDeleted) {
                ...
                request.setAttribute("errorMessage", "Appointment not found or could not be deleted");
            }
        } catch (NumberFormatException e) {
            request.setAttribute("errorMessage", "Invalid Appointment ID");
        } catch (SQLException | DatabaseConnectionException e) {
            e.printStackTrace();
            request.setAttribute("errorMessage", "Database error while deleting appointment");
        }
